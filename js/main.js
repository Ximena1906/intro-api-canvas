//Cuadrado
// Obtiene una referencia al elemento <canvas> con el id "canvas" en el HTML.
var canvas = document.getElementById("canvas");

// Obtiene el contexto de renderizado 2D del canvas. Este objeto permite dibujar sobre el canvas.
var ctx = canvas.getContext("2d");

// Establece el color de relleno para las figuras que se dibujen en el canvas. En este caso, el color es verde.
ctx.fillStyle = "rgb(246, 255, 122)";

// Dibuja un rectángulo relleno (con color verde) en el canvas.
// El rectángulo comenzará en la coordenada (10, 10) y tendrá un tamaño de 100x100 píxeles.
